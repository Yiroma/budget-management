...
public class SubscriptionMapper {
	...
	public static SubscriptionResponse toResponse(Subscription subscription) {
		return new SubscriptionResponse(subscription.getId(), subscription.getPlan(), subscription.getMaxAccounts(),
				subscription.getMaxBudgets(), subscription.getMaxMembersPerBudget(), subscription.getHasAds());
	}
}
